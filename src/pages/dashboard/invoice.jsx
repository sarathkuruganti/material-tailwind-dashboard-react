  ...
  {invoices.map((invoice) => (
    <div key={invoice.id} className="bg-white shadow-lg rounded-lg p-4 border border-gray-200">
      ...
      <p className="text-sm mb-1 flex items-center">
        <AiOutlineCalendar className="mr-2 text-gray-500" /> Date: {new Date(invoice.dateIssued).toLocaleDateString()}
      </p>
      <p className="text-sm mb-1 flex items-center">
        <AiOutlineDollar className="mr-2 text-gray-500" /> Total: ₹{invoice.total}
      </p>
      <p className="text-sm mb-1 flex items-center">
        <AiOutlineUser className="mr-2 text-gray-500" /> Customer: {invoice.invoiceTo}
      </p>
      <p className="text-sm mb-1 flex items-center">
        <AiOutlineHome className="mr-2 text-gray-500" /> Address: {invoice.customerAddress}
      </p>
      <p className="text-sm flex items-center">
        <AiOutlineTool className="mr-2 text-gray-500" /> Generated By: {invoice.generatedby}
      </p>
    </div>
  ))}
</div>
